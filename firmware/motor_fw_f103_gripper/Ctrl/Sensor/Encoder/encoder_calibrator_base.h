...
public:
    ...
    typedef enum
    {
        ...
        CALI_ERROR_VERIFY_FAIL,     // P0-10: Flash write verification failed
    } Error_t;
...
private:
    ...
    // P0-10: Flash read-back for write verification (local buffer used per-read)
    virtual void ReadFlash16bits(uint16_t* data, uint32_t num) = 0;
};
